...
art = r"""
                 _                  _   _     
 _ __  _ __ __ _| | _____  ___ _ __| |_| |__  
| '_ \| '__/ _` | |/ / _ \/ _ \ '__| __| '_ \ 
| |_) | | | (_| |   <  __/  __/ |  | |_| | | |
| .__/|_|  \__,_|_|\_\___|\___|_|   \__|_| |_|
|_|                                        
"""

utils.print(f'{G}{art}{W}\n')

utils.print(f'{G}[>] {C}Modified by  : {W}Prakeerth (instagram:mr_lotta_1.0)')
utils.print(f'{G}[>] {C}LinkedIn     : {W}https://www.linkedin.com/in/prakeerth-prakash')
utils.print(f'{G}[>] {C}GitHub       : {W}https://github.com/crazygamer2222')
